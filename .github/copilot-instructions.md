...
- A playability violation is a hard error — except the documented warnings (P10 clean vertical tiling, and the verifier's V-P11 convention check; `docs/design.md` §9), which are intentional and should not be flagged as bugs.
