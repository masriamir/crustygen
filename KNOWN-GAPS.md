...
735 tests (604 lib + 3 crustygen-build unit + 17 build_cli + 11 check_adversarial + 16 check_cli +
...
vocabulary_arbiter + 3 vocabulary_tables + 1 walking_skeleton + 21 in the `liftprobe` example),
