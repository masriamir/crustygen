...
781 tests (620 lib + 3 crustygen-build unit + 17 build_cli + 12 check_adversarial + 16 check_cli +
...
vocabulary_arbiter + 3 vocabulary_tables + 1 walking_skeleton + 50 in the `liftprobe` example),
